...
namespace Assets.Scripts.Architecture.Services
{
    public class AudioService : IAudioService
    {
        ...
        private void InitializeSfxAudioSource() =>
            _sfxAudioSource = _baseFactory.CreateBaseObjectWithContainer<AudioSource>(AssetPath.SfxAudioSource);

        private void InitializeMusicAudioSource() =>
            _musicAudioSource = _baseFactory.CreateBaseObjectWithContainer<AudioSource>(AssetPath.MusicAudioSource);
    }
}